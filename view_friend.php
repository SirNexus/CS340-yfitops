...
<html>
    ...
    <body>
        <div class="header">
            ...
            <div class="container header-text text-center">Friend Profile</div>
...
<?php
	...
	$query = "SELECT DISTINCT s.Artist, s.ArtistImage FROM Song s, Owns o WHERE o.Username ='$friend' AND o.SongID = s.SongID";
